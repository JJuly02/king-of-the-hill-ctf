...
echo 'CTF{w3b_rc3_1gn1t10n_f00th0ld}'  > /home/www/user.txt
echo 'CTF{l4r4v3l_sud0_gtf0b1ns_r00t}' > /root/root.txt
chmod 644 /home/www/user.txt; chown www:www /home/www/user.txt
...
cp /opt/golden/sudoers.golden /etc/sudoers.d/www; chmod 440 /etc/sudoers.d/www
# start the vulnerable service as www (foothold = www)
# --- anti-LLM decoys (filesystem + cron honeypots) ---
for D in /home/www /opt/app /; do
...
exec su www -c "python3 /opt/app/server.py"
