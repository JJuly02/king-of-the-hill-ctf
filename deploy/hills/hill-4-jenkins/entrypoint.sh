#!/bin/sh
set -e
id jenkins >/dev/null 2>&1 || useradd -m -s /bin/sh jenkins
echo 'CTF{j3nk1ns_gr00vy_scr1pt_c0ns0l3}' > /home/jenkins/user.txt
echo 'CTF{h0st_pr1v3sc_sud0_r00t_w1n}'    > /root/root.txt
chmod 644 /home/jenkins/user.txt; chown jenkins:jenkins /home/jenkins/user.txt
...
for D in /home/jenkins /opt/app /; do
...
for D in / /opt/app /home/jenkins; do
...
exec su jenkins -c "python3 /opt/app/server.py"
